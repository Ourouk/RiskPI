...
def main(reference_path, input_path, output_dir, save_histogram, output_name=None):
...
if __name__ == "__main__":
    ...
    if args.histogram:
        print("histogram : true")
    else:
        print("histogram : false")
    ...
    main(args.reference, args.input, args.output, args.histogram, args.name)
